...
if __name__ == '__main__':
    ...
    for trial in range(TRIALS): ## TRIALS=1
        ...
        train_loader = DataLoader(data_train, 
                                    batch_size=NUM_CLASSES, # batchsize of the train_loader is the num_classes, since we only have a few samples in the train set
        ...
        for cycle in range(CYCLES): # cycles in config
            ...
            ### reversing arg, should be used at all times to sort from high to low
            ### uncertainty instead of low to high uncertainty.
            arg = reversed(arg)
